...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('📁 Uᴘᴅᴀᴛᴇs 📁', url='https://t.me/Nsmovies7')
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
           ...
           InlineKeyboardButton('😊 Backup 😊', url='https://t.me/Nsmovies7'),
            InlineKeyboardButton('😊 Request 😊', url='https://t.me/Nsmovies7')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('💥 Mᴏᴠɪᴇ Uᴘᴅᴀᴛᴇs 💥', url='https://t.me/Nsmovies7'),
            InlineKeyboardButton('🔎 Sᴇᴀʀᴄʜ Gʀᴏᴜᴘ 🔍', url='https://t.me/Nsmovies7')
            ],[
